            ...
            <Card className="shadow-lg rounded-xl overflow-hidden">
              ...
              <CardContent>
                <div className="aspect-w-16 aspect-h-9">
                  <iframe
                    src="https://calendar.google.com/calendar/embed?height=400&wkst=1&ctz=America%2FChicago&showPrint=0&title=REQS.TECH%20SCHEDULING&src=Y18yZjU2OGEyZTBmNjAyMzI4NDRlOTNiY2U5MGIyNzU0YjlhYjU3YmE1M2YyNzI3Zjk5OWQxNTEzZWNiZDZiYWE2QGdyb3VwLmNhbGVuZGFyLmdvb2dsZS5jb20&src=ZW4udXNhI2hvbGlkYXlAZ3JvdXAudi5jYWxlbmRhci5nb29nbGUuY29t&color=%23616161&color=%230b8043"
                    style={{ border: 0 }}
                    width="100%"
                    height="300"
                    frameBorder="0"
